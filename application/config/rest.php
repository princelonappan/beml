...
$config['auth_source'] = 'rest_enable_keys';
...
$config['auth_override_class_method']['key']['generate_key'] = 'none';
$config['auth_override_class_method']['deals']['payment_success'] = 'none';
$config['auth_override_class_method']['deals']['payment_error'] = 'none';
//$config['auth_override_class_method']['key']['test'] = 'none';
/*
|--------------------------------------------------------------------------
