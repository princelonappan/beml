                            ...
                            <tbody>
                                ...
                                foreach ($comments as $comment)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            <a href="<?php echo base_url();?>post/change_comment_status/<?php echo $comment['post_comment_id']; ?>/1/<?php echo $comment['post_id'];?>" >Approve</a>                                                                                   
                                        </td>
                                        <td class="td-actions">
                                            <a href="<?php echo base_url();?>post/change_comment_status/<?php echo $comment['post_comment_id']; ?>/2/<?php echo $comment['post_id'];?>">Deactive</a>                                                                                   
                                        </td>
                                        <td class="td-actions">
                                             <a href="<?php echo base_url();?>post/change_comment_status/<?php echo $comment['post_comment_id']; ?>/3/<?php echo $comment['post_id'];?>">Ignore</a>
                                        </td>
                                    </tr>
                        <?php } ?>
                            </tbody>
