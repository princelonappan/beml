...
<link rel="stylesheet" href="<?php echo base_url("assests/css/style.css"); ?>" />
		<!--[if IE 7]>
		  <link rel="stylesheet" href="<?php echo base_url("assests/css/font-awesome-ie7.min.css"); ?>" />
		<![endif]-->
		...
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="<?php echo base_url("assests/css/ace-ie.min.css"); ?>" />
		<![endif]-->

		<!--application specific styles-->
		<link rel="stylesheet" href="<?php echo base_url("assests/css/admin_app.css"); ?>" />
		<link rel="stylesheet" href="<?php echo base_url("assests/css/jquery-ui.css"); ?>" />
                <!--[if !IE]>-->
...
<![endif]-->
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='<?php echo base_url("assests/js/jquery-2.0.3.min.js"); ?>assests/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		...
		<script src="<?php echo base_url("assests/js/jquery.dataTables.bootstrap.js"); ?>"></script>
		...
		<script src="<?php echo base_url("assests/js/ace.min.js"); ?>"></script>
                <script src="<?php echo base_url("assests/js/jquery-ui.js"); ?>"></script>
